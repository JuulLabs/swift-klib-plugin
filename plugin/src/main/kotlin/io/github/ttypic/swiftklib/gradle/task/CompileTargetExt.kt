...
internal fun CompileTarget.linkerMinOsVersionName() = when(this) {
    ...
    CompileTarget.watchosX64 -> "watchos_version_min"
    CompileTarget.watchosArm64 -> "watchos_version_min"
    CompileTarget.watchosSimulatorArm64 -> "watchos_version_min"
    CompileTarget.tvosX64 -> "tvos_version_min"
    CompileTarget.tvosArm64 -> "tvos_version_min"
    CompileTarget.tvosSimulatorArm64 -> "tvos_version_min"
